...
class HTTP2ResponsePrimitives:
    ...
    def remove_http_2_route(inputs, outputs, state_machine):
        """
        Remove a route from the HTTP/2 server.
    ...
    def add_http_2_response_header(inputs, outputs, state_machine):
        """
        Add a header to a route on the HTTP/2 server.
    ...
    def remove_http_2_response_header(inputs, outputs, state_machine):
        """
        Remove a header from a route on the HTTP/2 server.
