    ...
    def start_ssl_server(inputs, outputs, state_machine):
        ...
        Args:
            inputs (List[str]): The list of input variable names. It contains five mandatory input arguments:
                - The name of the variable containing the path to the certificate file.
                - The name of the variable containing the path to the key file.
        ...
        Returns:
            None
        """
        certfile = state_machine.get_variable_value(inputs[0])
        keyfile = state_machine.get_variable_value(inputs[1])
