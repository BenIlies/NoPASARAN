...
# Import original aioquic classes for overriding
from aioquic.h3.connection import H3Connection as OriginalH3Connection
from aioquic.h3.connection import H3Stream as OriginalH3Stream
import aioquic.h3.connection as h3_connection_module
import aioquic.h3.exceptions as h3_exceptions_module
...
# Override aioquic classes with modified implementations
redefine_methods(OriginalH3Connection, {
    '__init__': H3Connection.__init__,
    'create_webtransport_stream': H3Connection.create_webtransport_stream,
    'handle_event': H3Connection.handle_event,
    'send_datagram': H3Connection.send_datagram,
    'send_push_promise': H3Connection.send_push_promise,
    'send_data': H3Connection.send_data,
    'send_headers': H3Connection.send_headers,
    '_create_uni_stream': H3Connection._create_uni_stream,
    '_decode_headers': H3Connection._decode_headers,
    '_encode_headers': H3Connection._encode_headers,
    '_get_or_create_stream': H3Connection._get_or_create_stream,
    '_get_local_settings': H3Connection._get_local_settings,
    '_handle_control_frame': H3Connection._handle_control_frame,
    '_check_content_length': H3Connection._check_content_length,
    '_handle_request_or_push_frame': H3Connection._handle_request_or_push_frame,
    '_init_connection': H3Connection._init_connection,
    '_log_stream_type': H3Connection._log_stream_type,
    '_receive_datagram': H3Connection._receive_datagram,
    '_receive_request_or_push_data': H3Connection._receive_request_or_push_data,
    '_receive_stream_data_uni': H3Connection._receive_stream_data_uni,
    '_validate_settings': H3Connection._validate_settings,
    'received_settings': H3Connection.received_settings,
    'sent_settings': H3Connection.sent_settings
})

redefine_methods(OriginalH3Stream, {
    '__init__': H3Stream.__init__
})

# Override module-level functions
redefine_methods(h3_connection_module, {
    'encode_frame': encode_frame,
    'encode_settings': encode_settings,
    'parse_max_push_id': parse_max_push_id,
    'parse_settings': parse_settings,
    'stream_is_request_response': stream_is_request_response,
    'validate_header_name': validate_header_name,
    'validate_header_value': validate_header_value,
    'validate_headers': validate_headers,
    'validate_push_promise_headers': validate_push_promise_headers,
    'validate_request_headers': validate_request_headers,
    'validate_response_headers': validate_response_headers,
    'validate_trailers': validate_trailers,
    'ErrorCode': ErrorCode,
    'FrameType': FrameType,
    ...
    'QpackDecompressionFailed': QpackDecompressionFailed,
    'QpackDecoderStreamError': QpackDecoderStreamError,
    'QpackEncoderStreamError': QpackEncoderStreamError,
    'ClosedCriticalStream': ClosedCriticalStream,
    'DatagramError': DatagramError,
    'FrameUnexpected': FrameUnexpected,
    'MessageError': MessageError,
    'MissingSettingsError': MissingSettingsError,
    'SettingsError': SettingsError,
    'StreamCreationError': StreamCreationError
})

# Override exception classes
redefine_methods(h3_exceptions_module, {
    'ProtocolError': ProtocolError,
    'QpackDecompressionFailed': QpackDecompressionFailed,
    'QpackDecoderStreamError': QpackDecoderStreamError,
    'QpackEncoderStreamError': QpackEncoderStreamError,
